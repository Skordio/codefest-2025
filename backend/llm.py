...
def generateQuiz(data):
    ...
    response = client.chat.completions.create(
        ...
        messages=[
            # {"role": "system", "content": "You are a helpful assistant."},
            {"role": "user", 
            "content": '''can you generate 20 multiple choie and true/false quiz questions with answers from this transcription, please respond in this json format only:{"quiz":[{"question":"", "choices":['True', 'False'], "answer":""}, {"question":"", "choices":["a) brief answer choices","b) ","c) ","d) "], "answer":""}]}. \n\n''' + data
            }
        ]
    )
